                ...
                <div className="container bg-white">
                    <div className="row pt-3 ">
                            ...
                            <div className="col-lg-4 shadow rounded-end col-md-roundede-end-none">
                                ...
                                >
                                    <div className="">
                                        <img src="https://res.cloudinary.com/dlxfoztlz/image/upload/v1658822029/whatsapp-logo-light-green-png-0_ygvmyb.png" className="rounded-circle mb-4  login-img" height={35} alt="..." />
                                        <h4 className="sign fw-bold"> Sign in</h4>
                                        <p className="account">Dont have account? <span style={{ color: "blue" }}>Sign Up</span></p>
                                    </div>
